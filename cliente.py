...
if __name__ == '__main__':
	...
	while op != 0:
		...
		print('[2] - Mostrar autores cadastrados')
		print('[3] - Cadastrar livro')
		print('[4] - Mostrar livros cadastrados')
		print('[5] - Cadastrar exemplar')
		print('[6] - Mostrar exemplares cadastrados')
		print('[0] - Sair')
		...
		if op == 1:
			...
			#tratamento de excessões
			try:
				codigo_autor = int(input('Codigo autor: '))
			except:
				print('O codigo do autor deve ser númerico')
				continue

			try:
				codigo_livro = int(input('Codigo livro: '))
			except:
				print('O codigo do livro deve ser númerico')
				continue

			titulo = input('Titulo do livro: ')
			editora = input('Editora: ')
			anoPublicacao = input('Ano publicacao: ')
			ISBN = input('ISBN: ')
			assunto = input('Assunto: ' )
			edicao = input('Edicao: ')
			Numero_pag = input('Numero de páginas: ')
			volume = input('Volume: ')

			l = Livro(codigo_autor, codigo_livro, titulo, editora, anoPublicacao, ISBN, assunto, edicao, Numero_pag, volume)
			#adiocionando livro a biblioteca
			b.livros = l
			...
			#codigo_livro, codigo_exemplar, dias_emprestimo

			#tratamento de excessões

			try:
				codigo_livro = int(input('Codigo do livro: '))
			except:
				print('O codigo do livro deve ser númerico')
				continue
			try:
				codigo_exemplar = int(input('Codigo do exemplar: '))
			except:
				print('O codigo do exemplar deve ser númerico')
				continue
			try:
				dias_emprestimo = int(input('Quantidade de dias que o livro pode ser emprestado: '))
			except:
				print('A quantidade de dias que o livro pode ser emprestado deve ser númerico')
				continue

			e = Exemplar(codigo_livro, codigo_exemplar, dias_emprestimo)
			b.exemplares = e
		elif op == 6:
			b.mostraExemplares

		trava = input('Aperte enter para limpar tela\n')
...
# 	os.system('cls || clear')
# 	return resp
# def op_cadastro(op, biblioteca, codigo_usuario):
# 	if op == 1:
...
# 		if len(b.autores) > 0:
# 			codigo = int(input('Código livro: '))
# 			titulo = str(input('Titulo: '))
# 			editora = str(input('Editora: '))
# 			anoPublicacao = int(input('Ano de Publicão: '))
# 			ISBN = str(input('ISBN: '))
# 			assunto = str(input('Assunto: '))
# 			edicao = str(input('Edicao: '))
# 			volume = str(input('Volume: '))
# 			numero_pag = int(input('Número páginas: '))
# 			flag = 0
# 			for i in b.autores:
# 				if i.codigo == ISBN:
# 					flag = 1
# 					l = Livro(codigo, titulo, editora, anoPublicacao, ISBN, assunto, edicao, numero_pag, volume)
# 					b.livros = l
# 					break
# 			if flag == 0:
# 				print('Autor do livro não cadastrado!')
...
# 		b.mostraLivros
# 	elif op == 3:
# 		#codigolivro, codigo_exemplar, ativo, motivo_baixa, dias_emprestimo
# 		if len(b.livros) > 0:
# 			codigo_livro = int(input('Codigo livro: '))
# 			codigo_exemplar = int(input('Codigo exemplar: '))
# 			dias_emprestimo = int(input('Dias de emprestimo: '))

# 			flag = 0

# 			for i in b.livros:
# 				if i.codigo == codigo_livro:
# 					flag = 1
# 					e = Exemplar(codigo_livro, codigo_exemplar, dias_emprestimo)
# 					b.exemplares = e
# 					break
...
# 	elif op == 4:
# 		#self, cod_usuario, cod_exemplar, cod_livro, data_emprestimo, data_para_devolver
# 		if len(b.exemplares) > 0:
# 			cod_usuario = codigo_usuario
# 			cod_exemplar = int(input('Codigo exemplar: '))
# 			cod_livro = int(input('Codigo livro: '))
# 			data_emprestimo = str(input('Data emprestimo: '))
# 			data_para_devolver = str(input('Data para devolver: '))
# 			##FAZER ESSA PARTE
# 			#if  cod_exemplar ce.codigo_exemplar:
# 		else:
# 			print('Sem exemplares cadastrados!')
"""
def __init__(self, codigo, nome, cpf, fone, endereco, bairro, cidade, cep, email):
	...
	u = Usuario(codigo, nome, cpf, fone, endereco, bairro, cidade, cep, email)
"""

"""
def realizar_emprestimo(self, usuario, exemplar, data_emprestimo):
        if exemplar.emprestar():
            emprestimo = Emprestimo(usuario, exemplar, data_emprestimo)
...
# op = -1
# while op != 0:
# 	op = sub_menu_biblioteca()
# 	op_cadastro(op, b, codigo)
