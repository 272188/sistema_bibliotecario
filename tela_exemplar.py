...
class Tela_Exemplar(object):
    """
    classe que representa a tela de cadastro de exemplar de livro, sendo esta especifica para administrador(es) do sistema.
    ...
    botao_cadastrar_exemplar :
        elemento instanciado do QPushButton, que foi rotulado para identifica-lo como o botao para cadastrar um exemplar de livro.
    botao_voltar_exemplar :
        elemento instanciado do QPushButton, que foi rotulado para identifica-lo como o botao para voltar da tela de cadastro de exemplar para a tela principal da biblioteca para administrador(es) do sistema.
    """
